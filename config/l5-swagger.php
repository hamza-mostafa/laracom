...
return [
    ...
    'paths' => [
        ...
        */
        ...
        /*
        |--------------------------------------------------------------------------
        | base path for the swagger-ui dist folder
        |--------------------------------------------------------------------------
        */


        'ui_base_path' => env('swagger_ui_base_path', base_path('vendor/swagger-api/swagger-ui/dist/')),
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | allowed files to be imported for the swagger ui
    |--------------------------------------------------------------------------
     */
    'ui_allowed_files' => [
        'favicon-16x16.png',
